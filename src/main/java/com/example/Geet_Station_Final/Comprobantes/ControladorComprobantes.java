package com.example.Geet_Station_Final.Comprobantes;
...
public class ControladorComprobantes {
    ...
    public String listar(Model model) {
        ...
        return carpeta + "Comprobante";
        
    }

    @GetMapping("/detalle_comprobante")
    public String detalle(@RequestParam(value = "id", required = false) Proforma id, Model model) {
        ...
        model.addAttribute("detalles_comprobantes", detalles);
        return carpeta + "detalle_comprobante";
